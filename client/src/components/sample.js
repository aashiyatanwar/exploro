export const Sample = [
    ...
    Instructions:"To begin making the�Masala Karela Recipe,de-seed the karela and slice. Do not remove the skin as the skin has all the nutrients.�Add the karela to the pressure cooker with 3 tablespoon of water, salt and turmeric powder and pressure cook for three whistles. Release the pressure immediately and open the lids. Keep aside.Heat oil in a heavy bottomed pan or a kadhai. Add cumin seeds and let it sizzle.Once the cumin seeds have sizzled, add onions and saute them till it turns golden brown in color.Add the karela,�red chilli powder, amchur powder, coriander powder and besan. Stir to combine the masalas into the karela.Drizzle a little extra oil on the top and mix again. Cover the pan and simmer�Masala Karela stirring occasionally until everything comes together well. Turn off the heat.Transfer�Masala Karela into a serving bowl and serve.Serve�Masala Karela�along with�Panchmel Dal�and�Phulka�for a weekday meal with your family.�","TranslatedInstructions":"To begin making the�Masala Karela Recipe,de-seed the karela and slice. Do not remove the skin as the skin has all the nutrients.�Add the karela to the pressure cooker with 3 tablespoon of water, salt and turmeric powder and pressure cook for three whistles. Release the pressure immediately and open the lids. Keep aside.Heat oil in a heavy bottomed pan or a kadhai. Add cumin seeds and let it sizzle.Once the cumin seeds have sizzled, add onions and saute them till it turns golden brown in color.Add the karela,�red chilli powder, amchur powder, coriander powder and besan. Stir to combine the masalas into the karela.Drizzle a little extra oil on the top and mix again. Cover the pan and simmer�Masala Karela stirring occasionally until everything comes together well. Turn off the heat.Transfer�Masala Karela into a serving bowl and serve.Serve�Masala Karela�along with�Panchmel Dal�and�Phulka�for a weekday meal with your family.�","URL":"https://www.archanaskitchen.com/masala-karela-recipe","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"2000cal",
    Money:170
}
    ,
    {Srno:"2",
    RecipeName:"????? ????????? ?????? - Spicy Tomato Rice (Recipe In Hindi)",
    TranslatedRecipeName:"Spicy Tomato Rice (Recipe)",
    Ingredients:"2-1/2 ?? ???? - ??? ??,3 ?????,3 ???? ????? ???? ???? ??? ?????,??? - ????? ??????,1 ???? ????? ??? ???,1/2 ???? ????? ????,1 ???? ????? ???? ??? ???,1/2 ???? ????? ???,1 ??? ?????,1 ???? ??? ?????,2 ???? ????? ???? - ?? ???????,1-1/2 ??? ????? ??? - ?????? ??????,1/2 ???? ????? ????",
    ...
    Course:"Main Course",
    Diet:"Vegetarian",
    Instructions:"????? ????????? ????? ?? ??? ???? ???? ????? ?? ??? ??. ?? ?? ?????? ???????? ??? ???? ?? ???? ?????? ??? ??.�?? ?? ???? ??? ??? ??? ????? ??? ?? ??? ???? ?? ??? ????? ??? ???, ??? ???, ???? ???? ?? 10 ?? 20 ???????? ?? ???? ??.�10 ?? 20 ???????? ?? ??? ????? ????, ???, ??? ?????, ???? ??? ????? ?? ??? ????? ?????�30 ???????? ??? ????? ????? ?? ?????? ???? ?? ???? ??. ????? ???? ???? ??? ?????, ??? ???? ?? ???? ??.�7 ?? 8 ???? ?? ??? ???? ?? ?? ??? ??? ??? ?? ??. ??? ?? ???? ??? ??????, ????? ??? ??? ???? ???? ?? ???? ??. ???? ??? ??????�????? ?????????�?? ????? ???? ????? ?? ???? ?? ??? ??? ?? ???? ?? ??? ??????","TranslatedInstructions":"To make tomato puliogere, first cut the tomatoes. Now put in a mixer grinder and puree it. Now heat oil in a pan. After the oil is hot, add chana dal, urad dal, cashew and let it cook for 10 to 20 seconds. After 10 to 20 seconds, add cumin seeds, mustard seeds, green chillies, dry red chillies and curry leaves. After 30 seconds, add tomato puree to it and mix. Add BC Belle Bhat powder, salt and mix it. Allow to cook for 7 to 8 minutes and then turn off the gas. Take it out in a bowl, add cooked rice and mix it. Serve hot. Serve tomato puliogre with tomato cucumber raita and papad for dinner.","URL":"http://www.archanaskitchen.com/spicy-tomato-rice-recipe-in-hindi","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"1920cal",
    Money:160
}
    ,
    ...
    Ingredients:"1-1/2 cups Rice Vermicelli Noodles (Thin),1 Onion - sliced,1/2 cup Carrots (Gajjar) - chopped,1/3 cup Green peas (Matar),2 Green Chillies,1/4 teaspoon Asafoetida (hing),1 teaspoon Mustard seeds,1 teaspoon White Urad Dal (Split),1 teaspoon Ghee,1 sprig Curry leaves,Salt - to taste,1 teaspoon Lemon juice","TranslatedIngredients":"1-1/2 cups Rice Vermicelli Noodles (Thin),1 Onion - sliced,1/2 cup Carrots (Gajjar) - chopped,1/3 cup Green peas (Matar),2 Green Chillies,1/4 teaspoon Asafoetida (hing),1 teaspoon Mustard seeds,1 teaspoon White Urad Dal (Split),1 teaspoon Ghee,1 sprig Curry leaves,Salt - to taste,1 teaspoon Lemon juice",
    PrepTimeInMins:20,
    CookTimeInMins:"30",
    TotalTimeInMins:"50",
    Servings:"4",
    ...
    URL:"http://www.archanaskitchen.com/ragi-vermicelli-semiya-recipe-healthy-finger-millet-semiya-breakfast","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"3000cal",
    Money:345
}
    ,
    ...
    URL:"http://www.archanaskitchen.com/gongura-chicken-curry-recipe-andhra-style-gongura-chicken","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"2500cal",
}
    ,
    {Srno:"5",
    RecipeName:"?????? ?????? ??? ???? ?????? - Adrak Chutney (Recipe In Hindi)",
    TranslatedRecipeName:"Andhra Style Alam Pachadi Recipe - Adrak Chutney (Recipe)",
    Ingredients:"1 ??? ????? ??? ???,1 ??? ????? ???? ??? ???,2 ???? ??? ?????,1 ??? ????? ????? ?? ???,3 ??? ???? - ??? ??,1 ????? - ??? ??,1 ????? - ??? ??,??? - ????? ??????,1 ???? ????? ???,???? - ????? ??,??? - ?????? ??????,1 ???? ???",
    ...
    URL:"https://www.archanaskitchen.com/andhra-style-allam-pachadi-ginger-chutney-recipe-in-hindi","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"1200cal",
    Money:150
}
    ,
    ...
    URL:"http://www.archanaskitchen.com/pudina-khara-pongal-recipe-rice-and-lentils-cooked-with-mint-leaves-mild-spices","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"2500cal",
    Money:250
}
    ,
    ...
    URL:"http://www.archanaskitchen.com/udupi-style-ash-gourd-coconut-curry-recipe","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"1500cal",
    Money:230
}
    ,
    ...
    URL:"https://www.archanaskitchen.com/black-bean-burrito-recipe","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"1800cal",
    Money:450
}
    ,
    ...
    URL:"http://www.archanaskitchen.com/spicy-crunchy-masala-idli-recipe","field16":"","field17":"","field18":"","field19":"","field20":"","field21":"","field22":"","field23":"","field24":"","field25":"",
    Calories:"2650cal",
    Money:330
}
    ,
    ...
    Ingredients:"1 ?? ???? ?? ?????,3/4 ?? ?????,18 ????? ????,2 ??? ????? ???? ??? ???,4 ???? ??? ?????,??? - ????? ??????,???? - ????? ??,3 ??? ?????,????? ????? - ????? ??,1 ??? ????? ???,1 ???? ????? ???,1/2 ???? ????? ????,1 ???? ??? ?????",
    ...
    field16:"",field17:"",field18:"",field19:"",field20:"",field21:"",field22:"",field23:"",field24:"",field25:"",
    Calories:"1920cal",
    Money:250
}
    ,
